...
const FORMATION_POSITIONS = {
  ...
  'I Formation': {
    ...
    LT:{x:34,y:55,role:'line'},RT:{x:66,y:55,role:'line'},
    QB:{x:50,y:62,role:'skill'},FB:{x:50,y:70,role:'skill'},TB:{x:50,y:78,role:'skill'},
    X:{x:15,y:55,role:'skill'},Z:{x:74,y:58,role:'skill'},Y:{x:85,y:55,role:'skill'},
  },
  'Power Formation': {
    C:{x:50,y:55,role:'line'},LG:{x:42,y:55,role:'line'},RG:{x:58,y:55,role:'line'},
    LT:{x:34,y:55,role:'line'},RT:{x:66,y:55,role:'line'},TE:{x:74,y:55,role:'line'},
    QB:{x:50,y:62,role:'skill'},FB:{x:62,y:70,role:'skill'},TB:{x:62,y:78,role:'skill'},
    WB:{x:82,y:58,role:'skill'},X:{x:15,y:55,role:'skill'},
  },
  'Doubles Formation': {
    C:{x:50,y:55,role:'line'},LG:{x:42,y:55,role:'line'},RG:{x:58,y:55,role:'line'},
    LT:{x:34,y:55,role:'line'},RT:{x:66,y:55,role:'line'},
    QB:{x:50,y:62,role:'skill'},TB:{x:50,y:72,role:'skill'},
    X:{x:12,y:55,role:'skill'},A:{x:26,y:58,role:'skill'},
    Z:{x:74,y:58,role:'skill'},Y:{x:88,y:55,role:'skill'},
  },
  'Twins (Wing) Formation': {
    C:{x:50,y:55,role:'line'},LG:{x:42,y:55,role:'line'},RG:{x:58,y:55,role:'line'},
    LT:{x:34,y:55,role:'line'},RT:{x:66,y:55,role:'line'},
    QB:{x:50,y:62,role:'skill'},TB:{x:50,y:72,role:'skill'},
    X:{x:12,y:55,role:'skill'},Wing2:{x:26,y:58,role:'skill'},
    WingZ:{x:74,y:58,role:'skill'},Y:{x:88,y:55,role:'skill'},
  },
  'Twins (Base) Formation': {
    C:{x:50,y:55,role:'line'},LG:{x:42,y:55,role:'line'},RG:{x:58,y:55,role:'line'},
    LT:{x:34,y:55,role:'line'},RT:{x:66,y:55,role:'line'},
    QB:{x:50,y:62,role:'skill'},HB3:{x:42,y:70,role:'skill'},HB2:{x:58,y:70,role:'skill'},
    X:{x:15,y:55,role:'skill'},Z:{x:74,y:58,role:'skill'},Y:{x:88,y:55,role:'skill'},
  },
  'Trips Formation': {
    C:{x:50,y:55,role:'line'},LG:{x:42,y:55,role:'line'},RG:{x:58,y:55,role:'line'},
    LT:{x:34,y:55,role:'line'},RT:{x:66,y:55,role:'line'},
    QB:{x:50,y:62,role:'skill'},TB:{x:50,y:72,role:'skill'},
    X:{x:10,y:55,role:'skill'},A:{x:22,y:58,role:'skill'},Z:{x:30,y:58,role:'skill'},
    Y:{x:88,y:55,role:'skill'},
  },
  '4-2-5 Ring of Fire': {
