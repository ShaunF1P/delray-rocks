...
const POSITIONS = {
  ...
  special: [
    { key: 'K/R', label: 'Kicker / Returner' },
    { key: 'L1', label: 'Left Side 1' },
    { key: 'L2', label: 'Left Side 2' },
    { key: 'L3', label: 'Left Side 3' },
    { key: 'L4', label: 'Left Side 4' },
    { key: 'L5', label: 'Left Side 5' },
    { key: 'R1', label: 'Right Side 1' },
    { key: 'R2', label: 'Right Side 2' },
    { key: 'R3', label: 'Right Side 3' },
    { key: 'R4', label: 'Right Side 4' },
    { key: 'R5', label: 'Right Side 5' },
  ],
};
